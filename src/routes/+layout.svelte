...
>
	<h1 class="text-3xl font-bold">Yact</h1>

	{#if code}
		<Button onclick={copy} variant="ghost" class="group cursor-pointer flex flex-row items-center gap-2 font-mono text-2xl p-6">{code}<ClipboardIcon class="size-6 pb-1 opacity-0 transition-opacity group-hover:opacity-75 cursor-pointer"/></Button>
	{/if}
